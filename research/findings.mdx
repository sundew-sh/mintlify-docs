...
We plan to share the full findings — including anonymized datasets, behavioral taxonomies, and detection heuristics — here once the study concludes. Preliminary results will be presented at **DEF CON**.

To get notified when findings drop, star the [sundew-sh/sundew](https://github.com/sundew-sh/sundew) repo or join our [Discord](https://discord.gg/sundew).
